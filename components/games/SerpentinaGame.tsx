...
import { SerpentinaEngine, H, W } from "@/lib/games/serpentina/engine";
import type { GameComponentProps, GameEngineHandle } from "@/lib/games/registry";

export function SerpentinaGame({ onSnapshot, onReady }: GameComponentProps) {
  ...
  useEffect(() => {
    ...
    const engine = new SerpentinaEngine(ctx);
    engine.init();
